...
router.get('/report', requireAdmin, async (req, res) => {
    ...
    try {
        ...
        if (format === 'pdf') {
            ...
            // Title
            doc.fontSize(20).font('Courier-Bold').text('Organization X', { align: 'center' });
            doc.fontSize(14).font('Courier').text('Financial Report', { align: 'center' });
            ...
            doc.font('Courier-Bold').fontSize(12).text('Summary');
            ...
            // Table header
            doc.font('Courier-Bold').fontSize(11).text('Transactions');
            doc.moveDown(0.5);

            if (txns.length === 0) {
                doc.font('Courier').fontSize(10).text('No transactions in this period.');
            } else {
                txns.forEach(t => {
